...
for (const file of inspectedFiles) {
  ...
  if (/x-draw-duo-user|DRAW_DUO_TEST_MODE|NEON_API_KEY|NEON_AUTH_COOKIE_SECRET/.test(content)) blockers.push(`test_identity_or_secret_present:${path.relative(root, file)}`)
}
